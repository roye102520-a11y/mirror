    ...
    <>
      ...
      <main className="mx-auto max-w-xl px-6 py-14">
        ...
        <textarea
          ...
          rows={10}
          className="mt-8 w-full resize-y border border-[var(--line)] bg-white p-4 text-sm text-[var(--ink)] placeholder:text-[var(--muted)] focus:border-[var(--accent)] focus:outline-none"
