...
export function GentlePromptCard({ prompt, onPick }: Props) {
  return (
    <button
      ...
      className="mirror-gentle-prompt-card group w-full rounded-xl border border-white/55 bg-[rgba(255,255,255,0.42)] px-4 py-3 text-left shadow-mirror transition hover:border-[var(--accent)]/35 hover:bg-[rgba(255,255,255,0.55)] focus-visible:border-[var(--accent)] focus-visible:outline-none"
    >
